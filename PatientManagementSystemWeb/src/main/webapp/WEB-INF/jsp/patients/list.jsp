...
<head>
    ...
    <title>Patients - Patient Management System</title>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="search-container">
                <input type="text" class="search-input" placeholder="Search patients by name, email, or phone...">
                    ...
                    <tbody>
                        <c:forEach var="patient" items="${patients}">
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="/web/patients/${patient.id}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="/web/patients/edit/${patient.id}" class="btn btn-primary btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="/web/patients/delete/${patient.id}"
                        ...
                        <c:if test="${empty patients}">
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 2rem; color: #666;">
                                    ...
                                    <br>No patients found. <a href="/web/patients/new">Add the first patient</a>
                                </td>
                            </tr>
                        </c:if>
                    </tbody>
